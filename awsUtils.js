...
/**
 * Envia o arquivo dados2.json para o bucket S3
 */
function enviarJson() {
  const arquivoJson = path.join(__dirname, "dados2.json");

  if (!fs.existsSync(arquivoJson)) {
    console.error("Arquivo dados2.json não encontrado!");
    return;
  }
...
/**
 * Gera uma URL pré-assinada para o arquivo dados2.json
 */
...
module.exports = { enviarJson, getPublicUrl };
